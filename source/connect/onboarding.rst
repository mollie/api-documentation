...
Now, your customer is ready to start onboarding. To make the process even easier for them, you can send data you already
have using the :doc:`/reference/v2/onboarding-api/submit-onboarding-data` endpoint.
